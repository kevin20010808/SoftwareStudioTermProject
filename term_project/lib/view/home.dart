...
class _HomeState extends State<Home> {
  ...
  Widget _buildCircularProgressIndicator(
      double value, String label, double maxValue) {
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border.all(
                        color: Colors.black, width: 4), // Outer black border
                    borderRadius: BorderRadius.circular(90), // Make it circular
                  ),
                  child: Center(
                    child: Container(
                      height:
                          172, // Slightly smaller to fit inside the outer border
                      width:
                          172, // Slightly smaller to fit inside the outer border
                      decoration: BoxDecoration(
                        //border: Border.all(color: Colors.black, width: 2), // Inner black border
                        borderRadius:
                            BorderRadius.circular(86), // Make it circular
                        color: Theme.of(context).brightness == Brightness.dark
                            ? Color.fromARGB(255, 44, 10, 106)?.withOpacity(0.5)
                            : Colors
                                .white, // Conditionally set color based on theme
                        boxShadow: [
                          BoxShadow(
                            color: Colors.grey
                      ...
                      child: CircularProgressIndicator(
                        ...
                        strokeWidth:
                            12, // Increased stroke width for better visibility
  ...
  Widget _buildLinearProgressIndicator(
      double value, String label, double maxValue, Color color, IconData icon,
      {bool showValueLeft = true}) {
    double progressValue = maxValue > 0 ? value / maxValue : 0;
    return Column(
        ...
        Container(
          ...
          child: ClipRRect(
            ...
            child: LinearProgressIndicator(
              value: progressValue.isFinite
                  ? (progressValue > 1 ? 1 : progressValue)
                  : 0,
              backgroundColor: Colors
                  .transparent, // Make the background transparent to show the container's color
              color: color,
            ),
          ),
        ),
                    ...
                    ClipPath(
                      ...
                      child: Container(
                        ...
                        color: themeProvider.isDarkTheme
                            ? const Color.fromARGB(255, 44, 10, 106)
                                ?.withOpacity(0.5)
                            : Color.fromARGB(255, 101, 254, 8)
                                ?.withOpacity(0.5), // Color based on theme
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: <Widget>[
                                ...
                                children: <Widget>[
                                      ...
                                      Expanded(
                                        child: Column(
                                          children: [
                                            const SizedBox(
                                                height:
                                                    30), // Add space above the Fat bar
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                          width:
                                              150, // Set a specific width for the BMI progress bar
                                          child: Column(
                                            children: <Widget>[
                                              _buildLinearProgressIndicator(
                                                  bmi,
